...
public class HomePageDentista extends JFrame implements ActionListener {
    ...
    public static void main(String[] args) {
        new HomePageDentista().setVisible(true);
    }
    ...
    public void actionPerformed(ActionEvent e) {
      if (e.getSource() == num1) {
        	...
        	Successivi_Dentista successivi_Denti = new Successivi_Dentista();
            panel3.removeAll();
            panel3.revalidate();
            panel3.repaint();
            panel3.add(successivi_Denti.getPanelMain(), BorderLayout.CENTER);
