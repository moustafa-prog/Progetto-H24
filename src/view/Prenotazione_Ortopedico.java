...
import Modelo.PrenotazioneDAOIMP;
...
public class Prenotazione_Ortopedico extends JFrame {
    private PrenotazioneDAOIMP PrenotazioneOrtopedicoDAO = new PrenotazioneDAOIMP("prenotazione_ortopedico");
    JPanel panelMain = new JPanel(null);
    
    JLabel PrenotazioneOrtopedico = new JLabel("*PRENOTAZIONE*");
    JTable table;
    ...
    public Prenotazione_Ortopedico() {
    ...
    private void setupLayout() {
        ...
        PrenotazioneOrtopedico.setBounds(200, 100, 600, 50);
        ...
        panelMain.add(PrenotazioneOrtopedico);
        ...
        PrenotazioneOrtopedico.setFont(new Font("ALGERIAN", Font.BOLD, 50));
    ...
    private void addToDatabase() {
        ...
        for (int i = 0; i < tableModel.getRowCount(); i++) {
            ...
            try {
            	PrenotazioneOrtopedicoDAO.addPrenotazione(prenotazione);
    ...
    public static void main(String[] args) {
    	Prenotazione_Ortopedico frame = new Prenotazione_Ortopedico();
