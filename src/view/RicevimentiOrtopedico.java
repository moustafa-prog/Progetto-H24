...
public class RicevimentiOrtopedico extends JFrame {
    RicevimentoDAOImpl ricevimentoOrtopedicoDAO = new RicevimentoDAOImpl("ortopedico");
    ...
    private void deleteSelectedRows(ActionEvent e) {
        ...
        if (selectedRow != -1) {
            String codiceFiscale = (String) tableModel.getValueAt(selectedRow, 4); // Indice per CODICE_FISCALE
            try {
    ...
    private void saveLastRow(ActionEvent e) {
		...
		Ricevimenti ricevimento = new Ricevimenti(cognome, nome, data, ora, codiceFiscale, Tipo_di_utente );
        try {
