...
public class RicevimentiDentista extends JFrame {
    RicevimentoDAOImpl ricevimentoDentistaDAO = new RicevimentoDAOImpl("dentista");
    ...
    private void deleteSelectedRows(ActionEvent e) {
        ...
        if (selectedRow != -1) {
            ...
            try {
            	ricevimentoDentistaDAO.deleteRicevimento(codiceFiscale);
    ...
    private void saveLastRow(ActionEvent e) {
        ...
        try {
        	ricevimentoDentistaDAO.addRicevimento(ricevimento);
    ...
    private void loadDataFromDatabase() {
        try {
            List<Ricevimenti> ricevimenti = ricevimentoDentistaDAO.getAllRicevimenti();
    ...
    public static void main(String[] args) {
        RicevimentiDentista frame = new RicevimentiDentista();
