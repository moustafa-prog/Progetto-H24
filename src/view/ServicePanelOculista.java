...
public class ServicePanelOculista extends JFrame {
    private ServiziDAOimp serviziDAO = new ServiziDAOimp("Oculista");
    ...
    public static void main(String[] args) {
        ...
        frame.add(new ServicePanelOculista()); 
