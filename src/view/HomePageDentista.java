...
import dominio.ImagePanel;

@SuppressWarnings("serial")
public class HomePageDentista extends JFrame implements ActionListener {
    ...
    JButton num4 = new JButton("ASSISSTENZA");		
    JButton num6 = new JButton(" ORARIO");			
    JButton num5 = new JButton("I PAZIENTI");		
    JButton num7 = new JButton("USCITA");	
    JButton num8 = new JButton("VISITI");	
    public HomePageDentista(String nomeDottore, String specializzazione) {
       ...
       panel3 = new ImagePanel("C:\\Users\\peschiera721\\OneDrive\\Immagini\\Catture di schermata\\Screenshot 2024-08-08 142007.png");
        this.add(panel3);  
        label1.setColumns(15); // Aumenta la larghezza per mostrare correttamente il nome
        ...
        // Dimensioni di font
        Dottore.setFont(new Font("ADLaM Display", Font.BOLD, 50));
      ...
      panel1.add(DR);
        ...
        Dottore.setBounds(350, 20, 500, 45);
    ...
    public void actionPerformed(ActionEvent e) {
      if (e.getSource() == num1) {
            RicevimentiDentista ricivimenti = new RicevimentiDentista();
            panel3.removeAll();
            panel3.revalidate();
            panel3.repaint();
            panel3.add(ricivimenti.getPanelMain(), BorderLayout.CENTER);
        } else if (e.getSource() == num2) {
        	Prenotazione_Dentista prenotazione_dentista = new Prenotazione_Dentista();
            panel3.removeAll();
            panel3.revalidate();
            panel3.repaint();
            panel3.add(prenotazione_dentista.getPanelMain(), BorderLayout.CENTER);
        } else if (e.getSource() == num3) {
            ServicePanelDentista servicePanelDentista = new ServicePanelDentista();
            panel3.removeAll();
            panel3.revalidate();
            panel3.repaint();
            panel3.add(servicePanelDentista.getPanelA(), BorderLayout.CENTER);
        } else if (e.getSource() == num4) {
        	InventarioMaterialiDentista assistenza = new InventarioMaterialiDentista();
            panel3.removeAll();
            panel3.revalidate();
            panel3.repaint();
            panel3.add(assistenza.getPanelA(), BorderLayout.CENTER);
            }else if (e.getSource() == num5) {
                PazienteDentista pazienteDentista = new PazienteDentista();
            panel3.removeAll();
            panel3.revalidate();
            panel3.repaint();
            panel3.add(pazienteDentista.getPanelA(), BorderLayout.CENTER);
            }  else if (e.getSource() == num6) {
            Orario_Dottore_Dentista Denti = new Orario_Dottore_Dentista();
            panel3.removeAll();
            panel3.revalidate();
            panel3.repaint();
            panel3.add(Denti.getPanelA(), BorderLayout.CENTER);
            }
      ...
      public static void main(String[] args) {
          ...
          new HomePageDentista(nomeDottore, specializzazione).setVisible(true);
