...
public class Successivi_Ortopedico extends JFrame {
    private SuccessivoDAOIMP successivoOrtopedicoDAO = new SuccessivoDAOIMP("successivi_ortopedico");
    ...
    private void addToDatabase() {
        ...
        for (int i = 0; i < tableModel.getRowCount(); i++) {
            ...
            try {
                successivoOrtopedicoDAO.addSuccessivo(successivo);
    ...
    public static void main(String[] args) {
    	Successivi_Ortopedico frame = new Successivi_Ortopedico();
