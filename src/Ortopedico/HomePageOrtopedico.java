...
public class HomePageOrtopedico extends JFrame implements ActionListener {
    ...
    public HomePageOrtopedico(String nomeDottore) {
    ...
    public void actionPerformed(ActionEvent e) {
      if (e.getSource() == num1) {
    	  RicevimentiOrtopedico ricivimenti = new RicevimentiOrtopedico();
            panel3.removeAll();
            panel3.revalidate();
            panel3.repaint();
            panel3.add(ricivimenti.getPanelMain(), BorderLayout.CENTER);
        } else if (e.getSource() == num2) {
            Successivi_Ortopedico successivi_Occhi = new Successivi_Ortopedico();
            panel3.removeAll();
            panel3.revalidate();
            panel3.repaint();
