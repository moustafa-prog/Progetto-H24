...
public class Orario_Dottore_Dentista extends JFrame {
    private OrarioDottoreDAOimp orarioDottoreDAO = new OrarioDottoreDAOimp("dentista");
    ...
    public Orario_Dottore_Dentista() {
    ...
    public static void main(String[] args) {
        JFrame frame = new Orario_Dottore_Dentista();
