...
import Persone.VisitiDAO;
import Persone.VisitiDAOimp;

@SuppressWarnings("serial")
public class VisitiOculista extends JFrame {
    ...
    private VisitiDAO visitiDAO; // Dichiarazione del tipo come interfaccia

    public VisitiOculista() {
        this.setTitle("VISITI");
        this.setSize(800, 770);
        this.setDefaultCloseOperation(DISPOSE_ON_CLOSE);
        this.add(PanelA);

        // Inizializza il DAO per "dentista"
        visitiDAO = new VisitiDAOimp("oculista");
    ...
    private void loadVisitiForToday() {
        ...
        try {
            ...
            List<Visiti> visitiList = visitiDAO.getVisitiByDate(today);
