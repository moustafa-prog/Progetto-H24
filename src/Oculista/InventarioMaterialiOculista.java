...
import Persone.InventarioDAOImp;
import Persone.InventarioMateriale;

@SuppressWarnings("serial")
public class InventarioMaterialiOculista extends JFrame {
    private InventarioDAOImp inventarioDAO = new InventarioDAOImp("Oculista");
    ...
    public InventarioMaterialiOculista() {
    ...
    private void saveToDatabase() {
        ...
        InventarioMateriale materiale = new InventarioMateriale(nomeMateriale, quantitaDisponibile, quantitaMinima, descrizione, statoOrdine);
        try {
    ...
    public static void main(String[] args) {
        JFrame frame = new InventarioMaterialiOculista();
