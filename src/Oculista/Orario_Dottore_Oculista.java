...
import Persone.OrarioDottoreDAOimp;
...
public class Orario_Dottore_Oculista extends JFrame {
    private OrarioDottoreDAOimp orarioDottoreDAO = new OrarioDottoreDAOimp("oculista");
    ...
    public Orario_Dottore_Oculista() {
    ...
    public static void main(String[] args) {
        JFrame frame = new Orario_Dottore_Oculista();
