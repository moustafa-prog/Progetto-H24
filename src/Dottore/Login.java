...
import javax.swing.*;
import Dottore_Denti.HomePageDentista;
import Dottore_Occhi.HomePageOculista;
import Dottore_Stomaco.HomePageOrtopedico;
   ...
   private UserDAO<Login> userDAO = new UserDAOimp();
    ...
    private void checkEmail() {
        ...
        if (loginRiuscito) {
            ...
            // Apri l'interfaccia corrispondente in base al tipo di utente
            if (ortopedicoRadio.isSelected()) {
                new HomePageOrtopedico().setVisible(true);
            } else if (oculistaRadio.isSelected()) {
