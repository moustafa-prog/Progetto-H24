...
import Dottore.Paziente;
import Dottore.PazienteDAOimp;
...
public class PazienteOrtopedico extends JFrame {
    private PazienteDAOimp pazienteDAO = new PazienteDAOimp("stomaco");  // Specifica il tipo di paziente "occhi"
    ...
    public static void main(String[] args) {
        JFrame frame = new PazienteOrtopedico();
