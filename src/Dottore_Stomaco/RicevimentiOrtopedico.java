...
@SuppressWarnings("serial")
	public class RicevimentiOrtopedico extends JFrame {
	RicevimentoDAOImpl ricevimentoOrtopedicoDAO = new RicevimentoDAOImpl("stomaco");
    ...
    JLabel RicevimentiOrtopedico = new JLabel("*RECIVIMENTI *");
    public RicevimentiOrtopedico() {
        ...
        RicevimentiOrtopedico.setBounds(0, 30, 600, 50);
    ...
    private void deleteSelectedRows(ActionEvent e) {
        ...
        if (selectedRow != -1) {
            ...
            try {
            	ricevimentoOrtopedicoDAO.deleteRicevimento(codiceFiscale);
    ...
    private void saveLastRow(ActionEvent e) {
        ...
        try {
        	ricevimentoOrtopedicoDAO.addRicevimento(ricevimento);
	...
	private void loadDailyAppointments(ActionEvent e) {
        ...
        try {
        	List<Ricevimenti> ricevimenti = ricevimentoOrtopedicoDAO.getRicevimentiByDate(currentDay);
    ...
    private void loadDataFromDatabase() {
        try {
        	List<Ricevimenti> ricevimenti = ricevimentoOrtopedicoDAO.getAllRicevimenti();
    ...
    public static void main(String[] args) {
    	RicevimentiOrtopedico frame = new RicevimentiOrtopedico();
