...
public class InterfacciaPrincipaleOcchi extends JFrame implements ActionListener {
    ...
    public void actionPerformed(ActionEvent e) {
      if (e.getSource() == num1) {
            Recivimenti_Occhi ricivimenti = new Recivimenti_Occhi();
            panel3.removeAll();
            panel3.revalidate();
            panel3.repaint();
            ...
            ServicePanelOcchi servicePanelOcchi = new ServicePanelOcchi();
            panel3.removeAll();
            panel3.revalidate();
            panel3.repaint();
            panel3.add(servicePanelOcchi.getPanelA(), BorderLayout.CENTER);
        } else if (e.getSource() == num4) {
        	InventarioMaterialiOcchi i_dottore = new InventarioMaterialiOcchi();
            panel3.removeAll();
            panel3.revalidate();
            panel3.repaint();
            ...
            panel3.add(Occhi.getPanelA(), BorderLayout.CENTER);
                ...
                PazienteOcchi pazienteOcchi = new PazienteOcchi();
                panel3.removeAll();
                panel3.revalidate();
                panel3.repaint();
                panel3.add(pazienteOcchi.getPanelA(), BorderLayout.CENTER);
