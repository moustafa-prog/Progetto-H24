...
public class InterfacciaPrincipaleDenti extends JFrame implements ActionListener {
    ...
    public InterfacciaPrincipaleDenti() {
    ...
    public void actionPerformed(ActionEvent e) {
      if (e.getSource() == num1) {
            RecivimentiDenti ricivimenti = new RecivimentiDenti();
            panel3.removeAll();
            panel3.revalidate();
            panel3.repaint();
        	...
        	InventarioMaterialiDenti i_dottore = new InventarioMaterialiDenti();
            panel3.removeAll();
            panel3.revalidate();
            panel3.repaint();
            panel3.add(i_dottore.getPanelA(), BorderLayout.CENTER);
                ...
                Orario_Dottore_Denti Denti = new Orario_Dottore_Denti();
                panel3.removeAll();
                panel3.revalidate();
                panel3.repaint();
